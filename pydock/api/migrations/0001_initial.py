    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('homeworld', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='api.Planet')),
        ...
        migrations.AddField(
            model_name='people',
            name='homeworld',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='residents', to='api.Planet'),
        ),
        migrations.CreateModel(
            name='Vehicle',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('species', models.ManyToManyField(blank=True, related_name='films', to='api.Species')),
                ('starships', models.ManyToManyField(blank=True, related_name='films', to='api.Starship')),
                ('vehicles', models.ManyToManyField(blank=True, related_name='films', to='api.Vehicle')),
            ],
            options={
                'abstract': False,
            },
